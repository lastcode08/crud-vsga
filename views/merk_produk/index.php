					...
					<?php 
						...
						foreach ($results as $i => $result) { ?>
							<tr>
								...
								<td>
									<a class="btn btn-sm btn-warning" href="edit.php?id_merk=<?= $result['id_merk']; ?>">Ubah</a>
									<a class="btn btn-sm btn-danger" href="<?= $url; ?>/controller/merk_produk/delete.php?id_merk=<?= $result['id_merk']; ?>">Hapus</a>
								</td>
							</tr>
					<?php	}
					} ?>
