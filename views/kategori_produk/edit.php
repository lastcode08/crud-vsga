<?php 
	...
	$query = "SELECT nama_kategori FROM `kategori_produk` WHERE `id_kategori`=$id";
...
<body>
	    ...
	    <ul class="navbar-nav mr-auto">
	      ...
	      <li class="nav-item dropdown active">
	        ...
	        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	          ...
	          <a class="dropdown-item active" href="<?= $url; ?>/views/kategori_produk/">Kategori Produk</a>
	...
	<div class="container pt-5">
		<h1> <center>Ubah Kategori Produk</center></h1>
		<hr /> <br />
			...
			<div class="card-body">
				<form action="../../controller/kategori_produk/update.php" method="POST">
				  ...
				  <div class="form-group">
				    <label for="nama-merk">Nama Kategori Produk</label>
				    <input type="text" class="form-control form-control-sm" name="nama-kategori" placeholder="Masukkan Nama Kategori" value="<?= $result['nama_kategori']; ?>">
				  </div>
