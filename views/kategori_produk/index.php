					...
					<?php 
						...
						foreach ($results as $i => $result) { ?>
							<tr>
								...
								<td>
									<a class="btn btn-sm btn-warning" href="edit.php?id_kategori=<?= $result['id_kategori']; ?>">Ubah</a>
									<a class="btn btn-sm btn-danger" href="<?= $url; ?>/controller/kategori_produk/delete.php?id_kategori=<?= $result['id_kategori']; ?>">Hapus</a>
								</td>
							</tr>
					<?php	}
					} ?>
