<?php  
	...
	$query = "SELECT id_produk, nama_produk, warna, jumlah, harga, nama_merk, nama_kategori FROM produk INNER JOIN kategori_produk ON produk.id_kategori=kategori_produk.id_kategori INNER JOIN merk ON produk.id_merk=merk.id_merk;
;";
					...
					<?php 
						...
						foreach ($results as $i => $result) { ?>
							<tr>
								...
								<td><?= $result['nama_merk'];?></td>
								<td><?= $result['warna'];?></td>
								<td><?= $result['nama_kategori'];?></td>
								<td><?= $result['jumlah'];?></td>
								<td><?= $result['harga'];?></td>
								<td>
									<a class="btn btn-sm btn-warning" href="edit.php?id_produk=<?= $result['id_produk']; ?>">Ubah</a>
									<a class="btn btn-sm btn-danger" href="<?= $url; ?>/controller/produk/delete.php?id_produk=<?= $result['id_produk']; ?>">Hapus</a>
								</td>
							</tr>
					<?php	}
					} ?>
